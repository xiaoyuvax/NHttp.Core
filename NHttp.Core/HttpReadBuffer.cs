...
namespace NHttp
{
    internal class HttpReadBuffer
    {
        ...
        {
            _buffer = new byte[_bufferSize = size];
        }

        public bool DataAvailable => !_forceNewRead && _offset < _available;
        ...
        public void EndRead(Task<int> asyncResult) => _available += asyncResult.Result;
